function draw(){
  ...
  if(id === 'tyoutaroukai'){
    ...
    var top = {
      ...
      title:'ペラ焼き',
      text:'土佐清水の地元メのひとつ ペラ焼き。<br />たっぷりのネギとじゃこ天、卵を贅沢に<br />使用した粉物料理の《鉄板メニュー》です。<br /><br />薄く大きく伸ばされた生地に、<br />少しピリ辛のソースをかけていただきます。<br /><br />語源はこのペラペラした見た目からきて<br />おり、お好み焼きに並ぶ人気料理です。<br />'
    }
    var contents = [
      {
      name:'元祖ペラ焼き にしむら',
